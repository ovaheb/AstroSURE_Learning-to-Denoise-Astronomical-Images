    ...
    "narval":
        {
            ...
            "ram_per_gpu": 127500,
            "job_system": "slurm",
            "default_account": "def-rrg-kyi",
        },
}


jobs = ["python /home/ovaheb/code/train.py --batch_size 128 --scale noscale --epochs 300 --supervised N2C --loss L2 --enable_logging True --wandb_mode offline --data_path /home/ovaheb/projects/def-sdraper/ovaheb/simulated_data/trainsets/xsmall_radius"]
'''jobs = ['',
        '',
        '',
        '',
...
def slurm_command(num_cpu, num_gpu, mem, time_limit, account, job, partition, nodelist):
    com = ["sbatch"]
    ...
    com += ["--export=ALL"]
    com += ["--mail-user=omid.vaheb@mail.utoronto.ca"]
    com += ["--mail-type=ALL"]
    com += [job]
    return com
